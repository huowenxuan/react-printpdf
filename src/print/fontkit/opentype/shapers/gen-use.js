...
for (let i = 0; i < codepoints.length; i++) {
  ...
  if (codepoint) {
    let category = _getCategory(codepoint);
...
;
`
// const useMachine = fs.readFileSync(__dirname + '/use.machine', 'utf8')
let stateMachine = compile(useMachine, symbols);
